				...
				<View className="question-wrp">
					<View className="question-item">
						...
						<View className="que-follow">
							<View className="left">
								<View className="watch" style="display: inline-block">
									<Image src={img1} style="width: 25px;height: 25px"></Image>
									<Text>3316</Text>
								</View>
								<View className="comment" style="display: inline-block">
									<Image src={img2} style="width: 25px;height: 25px"></Image>
									<Text>27</Text>
								</View>
							</View>
					...
					<View className="que-operate flex-wrp">
						<View className="invite flex-item">
							<Image src={img3} style="width: 25px;height: 25px"></Image>
							<Text>邀请回答</Text>
						</View>
						<View className="write flex-item">
							<Image src={img4} style="width: 25px;height: 25px"></Image>
							<Text>写回答</Text>
						</View>
					</View>
				</View>
